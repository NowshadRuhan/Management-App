...
public class StudentWithFeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_with_fee);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Student With Fee");
    ...
    private void studentWithFee(String class_name, String section, String feeMonth) {


        Log.e("Class: ", class_name);
        Log.e("Section: ", section);
        Log.e("Selected Month", feeMonth);

        studentsList = db.getAllStudentsMonthFeeHistory(class_name, section, feeMonth);
    ...
    public void loadFeeMonth(final String  class_name, final String section){
        ...
        spinnerfeemonth.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                studentWithFee(class_name, section, feeMonth);
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.gen_atd_pdf){
            Intent intent = new Intent(StudentWithFeeActivity.this, GenerateStudentWithFeePDFActivity.class);
            startActivity(intent);
        }
